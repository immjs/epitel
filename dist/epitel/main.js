...
export function EpitelMain() {
    ...
    useKeyboard((v) => {
        if (v === '\x13\x45' && location.pathname !== '/')
            navigate('/');
    });
